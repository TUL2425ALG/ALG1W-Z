...
public class Marathon {
    ...
    public static void printNumUnder2_07(int[] sorted_time_in_seconds) { //print1 //JV pro tuto úlohu nepotrebuju setridene pole, pokud ho mam muzu pouzit jiny efektivnejsi algoritmus
        int count = 0;
    ...
    public static void main(String[] args) {
        ...
        while (cond) {
            ...
            //Processing
            //JV vidim, ze pouzivate to co v semestralni praci, za me je to zbytecne komplikovane a zde ani trideni neni uplne vhodne
            //JV toto psala pani docentka ke zkousce: Při zápisu algoritmu není vyžadována 100% optimalizace.
            //JV Je ale nutné vyvarovat se nesmyslně neefektivním řešením, jako je například uspořádání pole pouze pro zjištění maxima.
            //Pro určení maxima (nebo je pozice) postačí jediný průchod polem, uspořádání není nutné. 
            //JV Při určení četnosti výskytu hodnot daných pevným rozsahem opět postačí jediný průchod polem, četnosti uchovávat v jiném poli.
            ...
            //JV zvolila bych radsi ciste metody pro vypocty, vypisovala pak na konci vsechny vysledky dohromady 
        }
